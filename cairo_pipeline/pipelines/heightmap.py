...
heightmap_p = [ cp.misc.text.log_layer, {'message' : 'Heightmap pipeline'}
                ...
                , cp.dcelp.geometry.create_circle_grid, { 'size' : 5,
                                                          'rad'  : [0, utils.constants.TWOPI],
                                                          'radius' : [0, 200] }
                #sample them
                , cp.misc.sampling.sample_layer, { 'n' : 5000,
                                                   'r' : 3,
                                                   'colour' : np.array([300, 0.4, 0.4, 0.15]),
                                                   'c_type' : 'hsla',
                                                   'target' : 'circle',
                                                   'choice' : -1,
                                                   'random' : lambda x: np.random.random(x),
                                                   'easing' : 'linear'}
                # , cp.misc.utils.wiggle_layer, { 'dir' : [0, utils.constants.TWOPI],
                #                                 'scale' : [-1,1] }
